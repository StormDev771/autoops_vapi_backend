    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          phoneNumber: {
            type: "string",
            description: `User's Phone Number. If there is no \"+\" before the number, please insert a \"+\" at the beginning. For example, if the number is \"2556623365\", convert it to \"+2556623365\".`,
          },
          serviceName: {
            type: "string",
            description: `This is service that user selected. for example \"Tire service\"`,
          },
          bookDateTime: {
            type: "string",
          },
...
const assignToolToAgent = async (agentId, toolIds, shop_name) => {
  const payload = {
    model: {
      provider: "openai",
      model: "gpt-4.1",
      messages: [
        {
          ...
          content: `
**Role & Personality:**  
You are a friendly, professional, and approachable service appointment coordinator for ${shop_name}. You speak naturally, in a warm and attentive tone. Keep the conversation engaging and human—guide the caller calmly and confidently, asking one clear question at a time. Avoid robotic or scripted responses. Prioritize understanding and connection.
...
7. **Customer Lookup:**  
   ...
   - If not found:  
     - Ask: “Is this your first time contacting ${shop_name}?”  
...
`,
      ...
      toolIds: [...toolIds, "66484164-ccfe-4702-a21e-4f9a4613db2b"],
    },
  };
