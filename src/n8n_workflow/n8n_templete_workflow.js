export const GET_VEHICLE_BY_PHONE = {
  name: "Get Vehicle by Phone test",
  nodes: [
    {
      parameters: {
        url: "https://api.autoops.com/v1/clients/cl_45c33c02223c4383b53d905d1fec1887/customers",
        sendQuery: true,
        queryParameters: {
          parameters: [
            {
    ...
    },
    {
      parameters: {
        httpMethod: "POST",
        path: "b3203603-556f-489c-ad74-08f973f9d0a0",
      ...
      name: "Webhook",
      webhookId: "b3203603-556f-489c-ad74-08f973f9d0a0",
    },
  ],
  connections: {
    "Get Customers": {
...
export const SUGGEST_APPT_SLOTS = {
  name: "Suggest Appt Slots test",
  nodes: [
    {
      parameters: {
        httpMethod: "POST",
        path: "2108bd57-08a0-4f58-8527-18d72732c137",
        responseMode: "responseNode",
        options: {},
      },
      type: "n8n-nodes-base.webhook",
      ...
      name: "Webhook",
      webhookId: "2108bd57-08a0-4f58-8527-18d72732c137",
    },
    {
      parameters: {
        url: "https://api.autoops.com/v1/clients/cl_45c33c02223c4383b53d905d1fec1887/services",
        sendHeaders: true,
        specifyHeaders: "json",
        jsonHeaders:
          '{\n  "Authorization": "Bearer crL8oSwUPhlstiHOth3j5D4qaphlwroflgizezlvakoHofoC2est3zegofu76Ab1"\n}',
    ...
    {
      parameters: {
        url: "https://api.autoops.com/v1/booking-flow/cl_45c33c02223c4383b53d905d1fec1887/availability",
        sendQuery: true,
        queryParameters: {
          parameters: [
            {
...
export const BOOK_APPT = {
  ...
  nodes: [
    ...
    },
    {
      parameters: {
        method: "POST",
        url: "https://api.autoops.com/v1/booking-flow/cl_45c33c02223c4383b53d905d1fec1887/book",
        sendHeaders: true,
        specifyHeaders: "json",
        jsonHeaders:
          '{\n  "Authorization": "Bearer crL8oSwUPhlstiHOth3j5D4qaphlwroflgizezlvakoHofoC2est3zegofu76Ab1"\n}',
    ...
    },
    {
      parameters: {
        httpMethod: "POST",
        path: "fbfa8682-76bf-45c6-b4c0-a18bc54caef0",
        responseMode: "responseNode",
        options: {},
      },
      type: "n8n-nodes-base.webhook",
      ...
      name: "Webhook",
      webhookId: "fbfa8682-76bf-45c6-b4c0-a18bc54caef0",
    },
    {
      parameters: {
        conditions: {
